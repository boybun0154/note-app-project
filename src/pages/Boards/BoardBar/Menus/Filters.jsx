  ...
  return (
    <Box>
      ...
      >
        ...
        <MenuItem sx={{ py: '4px'}} disableRipple>
          <FormControlLabel control={<Checkbox size='small' checked={janedoe} onChange={handleChange} name="janedoe" />} label="Jane Doe" />
        </MenuItem>
        <MenuItem sx={{ py: '4px'}} disableRipple>
          <FormControlLabel control={<Checkbox size='small' checked={brucewayne} onChange={handleChange} name="brucewayne" />} label="Bruce Wayne" />
        </MenuItem>
        <MenuItem sx={{ py: '4px'}} disableRipple>
          <FormControlLabel control={<Checkbox size='small' checked={clarkkent} onChange={handleChange} name="clarkkent" />} label="Clark Kent" />
        </MenuItem>
      </Menu>
    </Box>
  )
