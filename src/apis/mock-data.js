export const mockData = {
  board: {
    ...
    listOrderIds: ['column-id-03', 'column-id-01', 'column-id-02', 'column-id-04'], // Thứ tự sắp xếp / vị trí của các Columns trong 1 boards
    lists: [
      {
        _id: 'column-id-01',
        boardId: 'board-id-01',
        ...
        cards: [
          {
            ...
            title: 'Alo Alo',
            description: 'Messi Mãi Đỉnh',
            cover:
              'https://footwearnews.com/wp-content/uploads/2022/12/GettyImages-1450127078.jpg?w=1024',
